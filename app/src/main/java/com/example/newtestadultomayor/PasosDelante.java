...
public class PasosDelante extends AppCompatActivity {
    Button atras;
    Button terminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasos_delante);
            ...
            for (MinMax minMax : minMaxArray) {
                if (age >= minMax.minage && age <= minMax.maxage) {
                    if (male && input <= minMax.minresultm && input >= minMax.maxresultm) {
                        result = true;
                        break;
                    } else if (!male && input <= minMax.minresultf && input >= minMax.maxresultm) {
                        result = true;
                        break;
                    } else result = false;
                }
    ...
    private void llenarDatos() {
        minMaxArray[0] = new MinMax(60, 64, 5.6, 3.8, 6.0, 4.4);
        minMaxArray[1] = new MinMax(65, 69, 5.7, 4.3, 6.4, 4.8);
        minMaxArray[2] = new MinMax(70, 74, 6, 4.2, 7.1, 4.9);
        minMaxArray[3] = new MinMax(75, 79, 7.2, 4.6, 7.4, 5.2);
        minMaxArray[4] = new MinMax(80, 84, 7.6, 5.2, 8.7, 5.7);
        minMaxArray[5] = new MinMax(85, 89, 8.9, 5.3, 9.6, 6.2);
        minMaxArray[6] = new MinMax(90, 999, 1, 6.2, 11.5, 7.3);
    }
